//
//  PlatformsHomeViewController.swift
//  RAWG_SideProject
//
...
class PlatformsHomeViewController: UIViewController {
...
extension PlatformsHomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
           guard let platform = viewModel.getPlatform(at: indexPath.item) else { return }
           
           let platformsVC = PlatformsViewController()
           platformsVC.selectedPlatform = platform
           navigationController?.pushViewController(platformsVC, animated: true)
       }
...
extension PlatformsHomeViewController: UICollectionViewDelegateFlowLayout {
